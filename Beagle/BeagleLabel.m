...
- (void)setupLabel:(NSInteger)TypeFont {
    ...
    switch (TypeFont) {
        case 1:
        {
            ...
            _attributesLink = @{NSForegroundColorAttributeName:[[BeagleManager SharedInstance] darkDominantColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:17.0f]};
        ...
        case 2:
        {
            ...
            _attributesLink = @{NSForegroundColorAttributeName:[[BeagleManager SharedInstance] darkDominantColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue-Light" size:15.0f]};
