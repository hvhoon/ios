...
#define errorAlertTitle @"What happened to the internet?"
#define errorLimitedConnectivityMessage @"Wow so this is what the 80's felt like.  Please try again when you return to the present."
